...
/*   Updated: 2023/12/04 19:16:07 by escura           ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
{
	// if(settings->precision != -1 && settings->type == 's' && settings->width == 0){
	// 	if(settings->current_printed = settings->precision)
	// 		return ;
	// }
	// if(settings->type == 's' && settings->precision != -1 && settings->current_printed + 1 >= settings->precision)
	// 	return ;
	write(1, &c, 1);
	settings->printed++;
	settings->current_printed++;
}
